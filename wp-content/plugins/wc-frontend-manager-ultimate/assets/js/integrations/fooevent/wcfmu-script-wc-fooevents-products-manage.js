(function($) {
	...
	if ( jQuery( "#WooCommerceEventsEvent" ).length ) {
		...
		jQuery('#wcfm_products_manage_form_wc_fooevents_expander').on('click', '.upload_image_button_woocommerce_events', function(e) {
			e.preventDefault();
		...
		jQuery('.upload_reset').click(function(e) {
			e.preventDefault();
...
(function($) {
    ...
    jQuery("#WooCommercePrintTicketNrColumns").on('change', function(){
        ...
        jQuery("#fooevents_printing_layout_block .fooevents_printing_widget").each(function() {
    ...
    jQuery("#wcfm_products_manage_form_wc_fooevents_head").on("click", function(){
    ...
    jQuery('#fooevents_printing_layout_block .fooevents_printing_widget > span').on("click", function(){ 
    ...
    jQuery(function() {
        ...
        var dropOption = {
            ...
            drop: function (event, ui) {
                ...
                if (jQuery(this).is(".fooevents_printing_slot") && !jQuery(this).has(".fooevents_printing_widget").length) {
                    ...
                    jQuery(this).append(ui.draggable.css({
                    ...
                    jQuery(this).find(".fooevents_printing_widget > span").unbind('click').on("click", function(){
                        fooevents_show_hide_widget_details(jQuery(this));
                    });
        ...
        function fooevents_validate_slot($draggables) {
            ...
            $draggables.each(function () {
                var $target = jQuery(jQuery(this).data("target")).filter(function (i, elm) {
