...
if ( isset( $fooevent_Config->class_path ) && file_exists( $fooevent_Config->class_path . 'class-fooevents-woo-helper.php' ) ) {
	require_once( $fooevent_Config->class_path . 'class-fooevents-woo-helper.php' );
} else {
...
if ( isset( $fooevent_Config->class_path ) && file_exists( $fooevent_Config->class_path . 'class-fooevents-zoom-api-helper.php' ) ) {
	require_once( $fooevent_Config->class_path . 'class-fooevents-zoom-api-helper.php' );
		  	...
		  	<div id="WooCommerceEventsForm" style="display:none;">
				...
				<div class="options_group">
					<p class="form-field">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
							"WooCommerceEventsThankYouText" => array(
				...
				<div class="options_group">
					<p class="form-field">
						<?php 
						$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
							"WooCommerceEventsEventDetailsText" => array(
				...
				<div class="options_group">
					...
					<p class="form-field">
						<?php
						$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
							"WooCommerceEventsTicketLogo" => array( 
				...
				<div class="options_group">
					...
					<p class="form-field">
						<?php
						$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
							"WooCommerceEventsTicketHeaderImage" => array( 
				...
				<div class="options_group">
					<p class="form-field">
						<?php 
						$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
							"WooCommerceEventsTicketText" => array(
					...
					<div id="fooevents_pdf_ticket_settings" class="panel woocommerce_options_panel">
						...
						<div class="options_group">
							<p class="form-field">
								<?php 
								$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
									"FooEventsPDFTicketsEmailText" => array(
				...
				<?php if(!empty($product_id)) :?>
					...
					<div class="options_group">
						...
						<p class="form-field">
							<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
								"WooCommerceEventsTicketBackgroundImage" => array( 
					...
					<div class="options_group">
						<p class="form-field">
							<?php 
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
								"WooCommerceEventsExpireMessage" => array(
