		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-button-text-icon-wrapper svg, {{WRAPPER}} .premium-button-text-icon-wrapper svg path, {{WRAPPER}} .premium-drawable-icon' => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'premium_button_icon_switcher' => 'yes',
					'icon_type'                    => 'icon',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-button:hover .premium-button-text-icon-wrapper svg, {{WRAPPER}} .premium-button:hover .premium-button-text-icon-wrapper svg path, {{WRAPPER}} .premium-button:hover .premium-drawable-icon'   => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'premium_button_icon_switcher' => 'yes',
					'icon_type'                    => 'icon',
